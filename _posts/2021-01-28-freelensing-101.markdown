...
meta_description:
  Freelensing or Lens Whacking is a cheap and delightful way to add
  a unique, creative effect to your visuals.
subtitle:
  Freelensing or Lens Whacking is a cheap and delightful way to add a unique,
...
[Freelensing](https://en.wikipedia.org/wiki/Freelensing), or _lens whacking_ as it's also called, can also give you a ton of bang for the buck. You can create a dreamy visual look, with light leaks and focus shifts that are impossible to achieve with post-production plugins. And best of all, it's cheap.
