...
So, while people usually associate large format cameras with big Marvel-esque special effects sequences or large vistas, Laxton chose the ARRI Alexa 65 for [_If Beale Street Could Talk_](https://www.imdb.com/title/tt7125860/), a character-driven love story.
...
Laxton agrees that there are some challenges with razor-thin depth of field on large format cameras. For example, at some point during the filming of _If Beale Street Could Talk_, Laxton's AC asked him which eyelash did he want in focus.
...
Again Laxton goes back to his guiding principle, which is to pick the tool that matches the story. For him, _Beale Street_ is told from a singular perspective, so keeping focus and light on one subject works well. But in a different film, maybe this tool wouldn't be the best choice for the story.
...
During his masterclass, James Laxton talks at length about a variety of decisions he's had to make on set, not only while filming _Beale Street_ but also on the Academy Award-winning [Moonlight](<https://en.wikipedia.org/wiki/Moonlight_(2016_film)>). Whether it's lighting, lens choice, blocking, or camera movement, he emphasizes the word "feeling."
