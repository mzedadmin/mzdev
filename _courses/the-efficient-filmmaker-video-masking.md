...
Course Page:
  ...
  Main Text: |-
    ...
    In this course, Mascha Deikova walks you through AI masking workflows in DaVinci Resolve, Final Cut Pro, and Adobe After Effects. You'll learn selective color grading, face and content blurring, object removal, AI-powered relighting, and creative masking effects.
  ...
  Learning Topics:
  - Icon: Parameters
    Title: AI Masking Fundamentals
    Text: Understand how AI masking works using DaVinci Resolve's Magic Mask as your
      starting point.
  - Icon: Palette
    Title: Selective Color Grading
    Text: Apply targeted color grading to subjects and backgrounds using AI-generated
      masks.
  - Icon: Theme
    Title: Relight with AI
    Text: Combine Magic Mask with AI-powered Relight tools for advanced lighting adjustments
      in post.
  - Icon: Subtitle
    Title: Everyday Production Fixes
    Text: Blur faces, remove distractions, and handle practical production fixes quickly
      and cleanly.
  - Icon: Timeline
    Title: Cross-NLE Masking
    Text: Learn AI masking in Final Cut Pro's Magnetic Mask and Adobe After Effects'
      Roto Brush.
  - Icon: Performance
  ...
  - Lesson Title: How AI Masking Works - The Basics
    Lesson Description: Learn the fundamentals of AI masking using DaVinci Resolve's
      Magic Mask. Understand how the technology identifies and tracks subjects automatically.
  - Lesson Title: Selective Color Grading
    Lesson Description: Apply targeted color grading to specific subjects and backgrounds
      using AI-generated masks for precise, professional results.
  - Lesson Title: A Combined Magic Mask and Relight Workflow
    Lesson Description: Pair Magic Mask with DaVinci Resolve's AI-powered Relight
      tool for advanced lighting adjustments entirely in post-production.
  - Lesson Title: Everyday Applications in Video Production
